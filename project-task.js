...
function calculateMul(num3,num4){
   mul = num3 * num4;
   console.log(`The Product of ${num3} and ${num4} is ${mul}`);
...
//funtion to print names from a list
let names1 = ["Alice1","Bob1","Charlie1"];
function printNames(names1){
